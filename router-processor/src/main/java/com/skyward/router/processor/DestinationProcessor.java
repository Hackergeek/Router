package com.skyward.router.processor;
...
public class DestinationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        builder.append("package com.skyward.router.mapping;\n\n");
        ...
        String mappingFullClassName = "com.skyward.router.mapping." + className;
